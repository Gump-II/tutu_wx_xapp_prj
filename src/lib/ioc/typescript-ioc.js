...
var wxReflect = require("Reflect");

var Reflect = wxReflect.Reflect;
...
function InjectType(type) {
    ...
    if (args.length < 3 || typeof args[2] === "undefined") {
        return InjectPropertyDecoratorWithType.apply(type, this, args);
    }
    else if (args.length == 3 && typeof args[2] === "number") {
        return InjectParamDecorator.apply(this, args);
    }
...
function InjectPropertyDecoratorWithType(type, target, key) {
    IoCContainer.addPropertyInjector(target.constructor, key, type);
